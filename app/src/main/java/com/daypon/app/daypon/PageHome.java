...
public class PageHome extends Fragment {
    ...
    private void setSliderViews() {
        for (int i = 0; i < 3; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageUrl("https://s3.ap-northeast-2.amazonaws.com/daypon/slide1.jpg");
                    break;
                case 1:
                    sliderView.setImageUrl("https://s3.ap-northeast-2.amazonaws.com/daypon/slide2.jpg");
                    break;
                case 2:
                    sliderView.setImageUrl("https://s3.ap-northeast-2.amazonaws.com/daypon/slide3.jpg");
                    break;
            }
